...
#include "ChiAndPhiTaggingCriterion_Spec.hpp"
    ...
    //  BoxLoops::loop(
     //   PhiTaggingCriterion(m_dx, m_time, m_level, m_p.ref_times, m_p.ref_levels, m_p.threshold_chi, m_p.threshold_K),
      //  current_state, tagging_criterion);
        BoxLoops::loop(
        ChiAndPhiTaggingCriterion_Spec(m_dx, m_p.threshold_chi, m_p.threshold_phi, m_p.origin_x, m_p.origin_y, 
        m_p.L, m_p.center, m_level, m_p.max_ref_level),
        current_state, tagging_criterion);
  //  BoxLoops::loop(
