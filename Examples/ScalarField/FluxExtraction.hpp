  ...
  public:
    ...
    FluxExtraction(const spherical_extraction_params_t a_params, double a_dt,
        ...
        : SphericalExtraction(a_params, a_dt, a_time, a_first_step,
                              a_restart_time)
    {
        add_var(c_flux, VariableType::diagnostic);
     //   add_var(c_rhoLL, VariableType::diagnostic);
    }
    ...
    void execute_query(AMRInterpolator<Lagrange<4>> *a_interpolator)
    {
        ...
        add_var_integrand(m_flux, flux_integrals[m_flux],
                          IntegrationMethod::simpson);
       // add_var_integrand(m_rhoLL, flux_integrals[m_rhoLL],
                  //        IntegrationMethod::simpson);
