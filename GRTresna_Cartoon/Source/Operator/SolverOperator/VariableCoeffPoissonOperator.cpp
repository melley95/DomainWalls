    ...
    for (dit.begin(); dit.ok(); ++dit)
    {
        ...
        This_will_not_compile !
            ...
            (CHF_FRA(a_lhs[dit]), CHF_CONST_FRA(constraint_vars[dit]),
             ...
             CHF_CONST_FRA((*m_bCoef)[dit]), CHF_CONST_FRA((*m_cCoef)[dit]), CHF_BOX(region),
             CHF_CONST_REAL(m_dx));
    } // end loop over boxes
}
    ...
    for (dit.begin(); dit.ok(); ++dit)
    {
        ...
        This_will_not_compile !
            ...
            (CHF_FRA(a_lhs[dit]), CHF_CONST_FRA(constraint_vars[dit]),
             ...
             CHF_CONST_REAL(m_beta), CHF_CONST_FRA((*m_bCoef)[dit]), CHF_CONST_FRA((*m_cCoef)[dit]),
         ...
         ++dit)
    {
        ...
        This_will_not_compile !
            ...
            (CHF_FRA_SHIFT(res, civ), CHF_CONST_FRA_SHIFT(constraint_vars, iv),
             ...
             CHF_CONST_FRA_SHIFT(thisBCoef, iv), CHF_CONST_FRA_SHIFT(thisCCoef, iv), CHF_BOX_SHIFT(region, iv),
             CHF_CONST_REAL(m_dx));
    }
}
        ...
        for (dit.begin(); dit.ok(); ++dit)
        {
            ...
            This_will_not_compile !
                ...
                (CHF_FRA(a_constraint_vars[dit]), CHF_CONST_FRA(a_rhs[dit]),
                 ...
                 CHF_CONST_FRA((*m_aCoef)[dit]), CHF_CONST_REAL(m_beta),
                 CHF_CONST_FRA((*m_bCoef)[dit]),  CHF_CONST_FRA((*m_cCoef)[dit]),CHF_CONST_FRA(m_lambda[dit]),
