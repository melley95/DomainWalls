...
def plot_NG(a_data, ax, number):
    ...
    ax.plot(x_values,y_values, linestyle = '--' ,color='k', linewidth = 1.5)
...
def plot_eik(a_data, ax, number):
     ...
     ax.plot(x_values,y_values, linestyle = ':' ,color='r', linewidth = 1.5)
...
ds_total = yt.load("../hdf5/DWp_000000.2d.hdf5", "../hdf5/DWp_000001.2d.hdf5", "../hdf5/DWp_000002.2d.hdf5", "../hdf5/DWp_000003.2d.hdf5")
...
# for ds in ds_total[::1]:
 ...
 #  point = ds.r[0,0]
  ...
  #  print("scale", a_p)
    ...
    p.set_cmap(field=variable1, cmap="viridis")
    p.set_ylabel(r"$y$")
    p.set_xlabel(r"$x$")
    ...
    min_var1 = 0.0
    p.set_zlim(variable1, 0.0001, 100.0)
...
plt.savefig("../plots/test.png", dpi=200, bbox_inches = "tight")
