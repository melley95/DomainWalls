...
# Increase the brightness by modifying the CTF’s midpoint, scale, or by adjusting the colormap

# Example of changing the midpoint and scale
   
    p.set_cmap(field=variable1, cmap="RdBu")
    p.set_ylabel(r"$y$")
    p.set_xlabel(r"$x$")
 ...
 #  plot.title("\phi")
  ...
  #  yScalarFormatter.set_powerlimits((0,0))
    ...
    plt.savefig("phi_movie/"+"movie_z"+name+".png", dpi=200, bbox_inches = "tight")
    k += 1
    # print(i)
    plt.close()