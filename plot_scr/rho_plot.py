...
hdf5_filenames = [ "../hdf5/DWp_000070.2d.hdf5"]
...
for i, filename in enumerate(hdf5_filenames):
 ...
 #   grid[2].axes.set_xlabel(r"$y$")
  ...
  #  slc.swap_axes()
    ...
    grid[0].axes.set_xlabel(r"$x$",  fontsize=F2)
    ...
    grid[0].axes.set_xlim(-30, 3)
    grid[0].axes.set_ylim(-15, -5)
...
plt.savefig("../plots/prolate_rho_plot.png", dpi=200, bbox_inches = "tight")
plt.close()
